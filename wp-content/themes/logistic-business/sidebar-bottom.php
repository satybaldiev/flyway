...
if ( 
	...
	<div id="bottom" class="cmsmasters_color_scheme_<?php echo logistic_business_return_content($cmsmasters_option[CMSMASTERS_SHORTNAME . '_bottom_scheme']); ?>">
		<div class="bottom_bg">
			<div class="bottom_outer">
				<div class="bottom_inner sidebar_layout_<?php echo logistic_business_return_content($cmsmasters_bottom_sidebar_layout); ?>">
	<?php 
