...
function logistic_business_gutenberg_module_colors($custom_css = '', $is_editor = false) {
...
/***************** Start Gutenberg Module Custom Colors Scheme Rules ******************/
	...
	{$editor} div.wp-block ul > li:before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['logistic-business' . '_default_bg']) . "
	}

	{$editor} table thead tr th {
		" . cmsmasters_color_css('color', $cmsmasters_option['logistic-business' . '_default_bg']) . "
	}

	{$editor} table thead tr th {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['logistic-business' . '_default_heading']) . "
	}

	.wp-caption {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['logistic-business' . '_default_border']) . "
	}
	
	{$editor} .wp-block-quote,
	.editor-styles-wrapper .wp-block-freeform blockquote,
	.editor-styles-wrapper .wp-block-freeform blockquote p {
		" . cmsmasters_color_css('color', $cmsmasters_option['logistic-business' . '_default_color']) . "
	}
	
	{$editor} .wp-block-freeform blockquote:before,
	{$editor} div.wp-block ul > li:before,
	{$editor} blockquote:before,
	{$editor} q:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['logistic-business' . '_default_border']) . "
	}

	{$editor} hr {
		" . cmsmasters_color_css('background', $cmsmasters_option['logistic-business' . '_default_border']) . "
	}
	...
	{$editor} .wp-block-table.is-style-stripes tr:nth-child(odd) td {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['logistic-business' . '_default_alternate']) . "
	}
	...
	{$editor} .wp-block-freeform.mce-content-body > table thead td {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['logistic-business' . '_default_heading']) . "
		" . cmsmasters_color_css('border-color', $cmsmasters_option['logistic-business' . '_default_heading']) . "
	}
	...
	{$editor} .wp-block-freeform.mce-content-body > table thead th,
	{$editor} .wp-block-freeform.mce-content-body > table thead td {
		" . cmsmasters_color_css('color', $cmsmasters_option['logistic-business' . '_default_alternate']) . "
	}
	/* Finish Table Colors */
...
/***************** Start Gutenberg Module General Colors Scheme Rules ******************/
	...
	.editor-styles-wrapper .wp-block-file .wp-block-file__textlink .editor-rich-text__tinymce {
		" . cmsmasters_color_css('color', $cmsmasters_option['logistic-business' . '_default_link']) . "
	}
	...
	.editor-styles-wrapper div.wp-block .wp-block-freeform.block-library-rich-text__tinymce a:active {
		" . cmsmasters_color_css('color', $cmsmasters_option['logistic-business' . '_default_hover']) . "
	}
	
	.editor-styles-wrapper select:focus {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['logistic-business' . '_default_hover']) . "
	}
	...
	{$editor} .wp-block-pullquote {
		" . cmsmasters_color_css('color', $cmsmasters_option['logistic-business' . '_default_heading']) . "
	}
	...
	{$editor} .wp-block-separator:not(.is-style-dots):before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['logistic-business' . '_default_border']) . "
	}
	...
	{$editor} .wp-block-file a.wp-block-file__button {
		" . cmsmasters_color_css('color', $cmsmasters_option['logistic-business' . '_default_bg']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['logistic-business' . '_default_link']) . "
	}
	...
	{$editor} .wp-block-file a.wp-block-file__button:active {
		" . cmsmasters_color_css('color', $cmsmasters_option['logistic-business' . '_default_bg']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['logistic-business' . '_default_hover']) . "
	}
	
	{$editor} .wp-block-button.is-style-outline .wp-block-button__link:not(.has-text-color):not(.has-background) {
		" . cmsmasters_color_css('color', $cmsmasters_option['logistic-business' . '_default_link']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['logistic-business' . '_default_bg']) . "
		" . cmsmasters_color_css('border-color', $cmsmasters_option['logistic-business' . '_default_link']) . "
	}
...
add_filter('logistic_business_theme_colors_secondary_filter', 'logistic_business_gutenberg_module_colors');
