	...
	<div class="cmsmasters_post_cont">
		...
		if (!post_password_required()) {
			if ($cmsmasters_post_image_link != '') {
				logistic_business_thumb(get_the_ID(), 'cmsmasters-project-thumb', false, 'img_' . get_the_ID(), true, false, true, true, $cmsmasters_post_image_link);
			} elseif (has_post_thumbnail()) {
				logistic_business_thumb(get_the_ID(), 'cmsmasters-project-thumb', false, 'img_' . get_the_ID(), true, false, true, true, false);
			} else {
				logistic_business_post_format_icon_placeholder(get_the_ID(), 'image');
			}
		} else {
			logistic_business_post_format_icon_placeholder(get_the_ID(), 'image');
		}
