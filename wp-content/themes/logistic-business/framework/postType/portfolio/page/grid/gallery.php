	...
	<?php 
		...
		if (!$title) {
			echo '<div class="dn">';
				...
				logistic_business_project_heading(get_the_ID(), 'h5', true, $cmsmasters_project_link_redirect, $cmsmasters_project_link_url);
		...
		if ($title || $categories || $excerpt || $likes || $comments) {
			echo '<div class="project_inner">';
				...
				($title) ? logistic_business_project_heading(get_the_ID(), 'h6') : '';
