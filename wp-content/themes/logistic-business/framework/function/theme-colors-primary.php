...
function logistic_business_theme_colors_primary() {
...
/***************** Start {$title} Color Scheme Rules ******************/
	...
	{$rule}.quote_grid .wrap_quote_title,
	{$rule}.quote_grid .wrap_quote_title a,
	...
	{$rule}.cmsmasters_quotes_slider.cmsmasters_quotes_slider_type_center .wrap_quote_title,
	...
	{$rule}button,
	{$rule}.page #fbuilder .pbreak .pbPrevious,
	{$rule}.page #fbuilder .pbreak .pbNext,
	...
	{$rule}textarea:focus,
	{$rule}select:focus {
		-webkit-box-shadow:inset 0 0 0 1px " . $cmsmasters_option[CMSMASTERS_SHORTNAME . '_' . $scheme . '_link'] . ";
		box-shadow:inset 0 0 0 1px " . $cmsmasters_option[CMSMASTERS_SHORTNAME . '_' . $scheme . '_link'] . ";
	}
	...
	{$rule}.post.cmsmasters_masonry_type .cmsmasters_post_cont_info,
	{$rule}.post.cmsmasters_timeline_type .cmsmasters_post_cont_info,
	{$rule}.post.cmsmasters_masonry_type .cmsmasters_post_date,
	{$rule}.post.cmsmasters_puzzle_type .cmsmasters_post_date,
	{$rule}.quote_grid .wrap_quote_title a:hover,
	...
	{$rule}.quote_grid .wrap_quote_title .quote_title,
	...
	{$rule}.cmsmasters_img_rollover_wrap:hover .cmsmasters_img_rollover {
		background-color:rgba(" . color2rgb($cmsmasters_option[CMSMASTERS_SHORTNAME . '_' . $scheme . '_heading']) . ", 0.85);
	}
	...
	{$rule}.cmsmasters_button,
	{$rule}.cmsmasters_button:hover,
	{$rule}.page #fbuilder .pbreak .pbPrevious:hover,
	{$rule}.page #fbuilder .pbreak .pbNext:hover,
	{$rule}.cmsmasters_prev_arrow:hover, 
	{$rule}.cmsmasters_next_arrow:hover,
	...
	{$rule}.cmsmasters_quotes_slider.cmsmasters_quotes_slider_type_box .wrap_quote_title *,
	{$rule}.quote_grid .cmsmasters_quote .cmsmasters_quote_inner:before,
	{$rule}.cmsmasters_table thead tr th,
	{$rule}mark,
	{$rule}.cmsmasters_content_slider .owl-buttons > div > span,
	{$rule}.cmsmasters_posts_slider .cmsmasters_post_date .cmsmasters_day,
	{$rule}form .formError .formErrorContent,
	{$rule}.cmsmasters_icon_box.cmsmasters_icon_box_left_top:before,
	{$rule}.cmsmasters_icon_box.cmsmasters_icon_box_left:before,
	{$rule}.cmsmasters_icon_box.cmsmasters_icon_box_top:before,
	...
	{$rule}.cmsmasters_posts_slider .cmsmasters_post_date .cmsmasters_mon,
	...
	@media only screen and (max-width: 600px) {
		{$rule}html #page .blog.columns.puzzle .post:nth-child(even) .puzzle_post_content_wrapper:before {
			border-bottom-color:" . $cmsmasters_option[CMSMASTERS_SHORTNAME . '_' . $scheme . '_bg'] . " !important;
		}
	}
	...
	{$rule}.cmsmasters_items_filter_wrap .cmsmasters_items_sort_but > span:before,
	{$rule}.post_nav,
	{$rule}.cmsmasters_single_slider .cmsmasters_single_slider_item_date,
	{$rule}.cmsmasters_single_slider .cmsmasters_single_slider_item_inner,
	{$rule}.cmsmasters_img_wrap .img_placeholder,
	{$rule}.post.cmsmasters_default_type .cmsmasters_post_cont_info,
	{$rule}.post.cmsmasters_default_type .cmsmasters_post_date .published > span,
	{$rule}.post.cmsmasters_masonry_type .cmsmasters_post_date,
	{$rule}.post.cmsmasters_masonry_type .cmsmasters_post_cont_inner,
	{$rule}.post.cmsmasters_timeline_type .cmsmasters_post_date .published > span,
	{$rule}.post.cmsmasters_timeline_type .cmsmasters_post_cont_inner,
	{$rule}.post.cmsmasters_puzzle_type .preloader[class^=\"cmsmasters_theme_icon_\"], 
	{$rule}.post.cmsmasters_puzzle_type .preloader[class*=\" cmsmasters_theme_icon_\"],
	{$rule}.blog.opened-article .post .cmsmasters_post_cont_info,
	{$rule}.blog.opened-article .post .cmsmasters_post_date .published > span, 
	...
	{$rule}.cmsmasters-form-builder .check_parent input[type=\"radio\"] + label:before,
	{$rule}#fbuilder input[type=radio] + .field_before:before,
	{$rule}.page #fbuilder fieldset,
	{$rule}.page #fbuilder fieldset legend,
	{$rule}.notice_close,
	...
	{$rule}.post.cmsmasters_puzzle_type .cmsmasters_post_cont {
		-webkit-box-shadow:0 0 0 1px " . $cmsmasters_option[CMSMASTERS_SHORTNAME . '_' . $scheme . '_border'] . ";
		box-shadow:0 0 0 1px " . $cmsmasters_option[CMSMASTERS_SHORTNAME . '_' . $scheme . '_border'] . ";
	}
	
	@media only screen and (max-width: 768px) {
		{$rule}html #page .cmsmasters_tabs .cmsmasters_tabs_list .cmsmasters_tabs_list_item > a,
		{$rule}.cmsmasters_items_filter_wrap .cmsmasters_items_filter_list li.current a,
		{$rule}.cmsmasters_items_filter_wrap .cmsmasters_items_filter_list li a {
			" . cmsmasters_color_css('border-color', $cmsmasters_option[CMSMASTERS_SHORTNAME . '_' . $scheme . '_border']) . "
		}
	...
	{$rule}.bottom_inner .widget .widgettitle:before,
	{$rule}input[type=submit].wysija-submit-field,
	{$rule}.post.cmsmasters_default_type .cmsmasters_post_date .cmsmasters_day,
	{$rule}.post.cmsmasters_timeline_type .cmsmasters_post_date .cmsmasters_day,
	{$rule}.blog.opened-article .post .cmsmasters_post_date .cmsmasters_day,
	...
	{$rule}.blog.opened-article .post .cmsmasters_post_date,
	{$rule}.post.cmsmasters_timeline_type .cmsmasters_post_date {
		" . cmsmasters_color_css('border-top-color', $cmsmasters_option[CMSMASTERS_SHORTNAME . '_' . $scheme . '_secondary']) . "
	}
...
";
	...
	return apply_filters('logistic_business_theme_colors_primary_filter', $custom_css);
}
