 ...
 * @version		1.0.0
 * 
 * LearnPress Quiz Options Functions
 * Created by CMSMasters
 * 
 */


if (!function_exists('get_custom_lpr_quiz_meta_fields')) {
function get_custom_lpr_quiz_meta_fields() {
	...
	$cmsmasters_option_name = 'cmsmasters_lpr_quiz_';
	...
	$custom_lpr_quiz_meta_fields = array( 
		array( 
	...
	return $custom_lpr_quiz_meta_fields;
}
}
