...
function get_custom_tt_event_meta_fields() {
	...
	$cmsmasters_global_tt_event_hours = (isset($cmsmasters_option[CMSMASTERS_SHORTNAME . '_tt_event_hours']) && $cmsmasters_option[CMSMASTERS_SHORTNAME . '_tt_event_hours'] !== '') ? (($cmsmasters_option[CMSMASTERS_SHORTNAME . '_tt_event_hours'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_tt_event_hours_title = (isset($cmsmasters_option[CMSMASTERS_SHORTNAME . '_tt_event_hours_title']) && $cmsmasters_option[CMSMASTERS_SHORTNAME . '_tt_event_hours_title'] !== '') ? $cmsmasters_option[CMSMASTERS_SHORTNAME . '_tt_event_hours_title'] : '';
	
	$cmsmasters_global_tt_event_details_title = (isset($cmsmasters_option[CMSMASTERS_SHORTNAME . '_tt_event_details_title']) && $cmsmasters_option[CMSMASTERS_SHORTNAME . '_tt_event_details_title'] !== '') ? $cmsmasters_option[CMSMASTERS_SHORTNAME . '_tt_event_details_title'] : '';
	...
	$tabs_array['cmsmasters_tt_event'] = array( 
		'label' => esc_html__('Event', 'logistic-business'), 
	...
	$custom_tt_event_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Event Hours', 'logistic-business'), 
		...
		array( 
			'label'	=> esc_html__('Event Hours Title', 'logistic-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Event Details Title', 'logistic-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Event Details', 'logistic-business'), 
			'desc'	=> '', 
