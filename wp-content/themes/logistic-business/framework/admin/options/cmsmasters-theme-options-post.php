...
function get_custom_post_meta_fields() {
	...
	$tabs_array['cmsmasters_post'] = array( 
		'label' => esc_html__('Post', 'logistic-business'), 
	...
	$custom_post_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Post', 'logistic-business'), 
			'desc'	=> esc_html__('Don\'t Show', 'logistic-business'), 
		...
		array( 
			'label'	=> esc_html__('Post Image', 'logistic-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Gallery', 'logistic-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Audio Links', 'logistic-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Title', 'logistic-business'), 
		...
		array( 
			'label'	=> esc_html__("'Read More' Buttons Text", 'logistic-business'), 
			'desc'	=> esc_html__("Enter the 'Read More' button text that should be used in you blog shortcode", 'logistic-business'), 
			'id'	=> $cmsmasters_option_name . 'read_more', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('Read More', 'logistic-business') 
		), 
		array( 
			'id'	=> 'cmsmasters_post', 
			'type'	=> 'tab_finish' 
		...
		array( 
			'label'	=> esc_html__('Page Layout', 'logistic-business'), 
			'desc'	=> '', 
			'id'	=> 'cmsmasters_layout', 
			'type'	=> 'radio_img', 
			'hide'	=> '', 
			...
			'options' => array( 
				'r_sidebar' => array( 
					...
					'label' => esc_html__('Right Sidebar', 'logistic-business'), 
					'value'	=> 'r_sidebar' 
				), 
				'l_sidebar' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/sidebar_l.jpg', 
					'label' => esc_html__('Left Sidebar', 'logistic-business'), 
					'value'	=> 'l_sidebar' 
				), 
				'fullwidth' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/fullwidth.jpg', 
					'label' => esc_html__('Full Width', 'logistic-business'), 
					'value'	=> 'fullwidth' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Choose Right\Left Sidebar', 'logistic-business'), 
			'desc'	=> '', 
