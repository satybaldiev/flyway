...
function get_custom_page_meta_fields() {
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'logistic-business'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'logistic-business'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'logistic-business'), 
