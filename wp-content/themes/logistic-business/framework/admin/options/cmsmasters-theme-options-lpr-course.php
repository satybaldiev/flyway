...
function get_custom_lpr_course_meta_fields() {
	...
	$cmsmasters_global_lpr_course_title = (isset($cmsmasters_option[CMSMASTERS_SHORTNAME . '_lpr_course_title']) && $cmsmasters_option[CMSMASTERS_SHORTNAME . '_lpr_course_title'] !== '') ? $cmsmasters_option[CMSMASTERS_SHORTNAME . '_lpr_course_title'] : '';
	
	$cmsmasters_global_lpr_course_image = (isset($cmsmasters_option[CMSMASTERS_SHORTNAME . '_lpr_course_image']) && $cmsmasters_option[CMSMASTERS_SHORTNAME . '_lpr_course_image'] !== '') ? $cmsmasters_option[CMSMASTERS_SHORTNAME . '_lpr_course_image'] : '';
	...
	$tabs_array['cmsmasters_lpr_course'] = array( 
		'label' => esc_html__('Course', 'logistic-business'), 
	...
	$custom_lpr_course_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Course Title', 'logistic-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Course Featured Image', 'logistic-business'), 
			'desc'	=> '', 
