...
add_action('admin_menu', 'logistic_business_add_menu');
add_action('admin_init', 'logistic_business_register_settings');
...
function logistic_business_get_settings() {
	$output = array();
	
	
	$page = logistic_business_get_admin_page();
	...
	case CMSMASTERS_PAGE_BASENAME:
		...
		$cmsmasters_settings_page_title = esc_html__('Theme General Settings', 'logistic-business');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_general_sections_filter', logistic_business_options_general_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_general_fields_filter', logistic_business_options_general_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_general_tabs_filter', logistic_business_options_general_tabs());
	...
	case CMSMASTERS_PAGE_BASENAME . '-font':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Fonts Settings', 'logistic-business');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_font_sections_filter', logistic_business_options_font_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_font_fields_filter', logistic_business_options_font_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_font_tabs_filter', logistic_business_options_font_tabs());
	...
	case CMSMASTERS_PAGE_BASENAME . '-color':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Color Schemes', 'logistic-business');
		$cmsmasters_page_sections = logistic_business_options_color_sections();
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_color_fields_filter', logistic_business_options_color_fields(), $tab);
		$cmsmasters_page_tabs = logistic_business_options_color_tabs();
	...
	case CMSMASTERS_PAGE_BASENAME . '-element':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Elements Settings', 'logistic-business');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_element_sections_filter', logistic_business_options_element_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_element_fields_filter', logistic_business_options_element_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_element_tabs_filter', logistic_business_options_element_tabs());
	...
	case CMSMASTERS_PAGE_BASENAME . '-single':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Single Posts Settings', 'logistic-business');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_single_sections_filter', logistic_business_options_single_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_single_fields_filter', logistic_business_options_single_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_single_tabs_filter', logistic_business_options_single_tabs());
	...
	case CMSMASTERS_PAGE_BASENAME . '-demo':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Settings Import/Export', 'logistic-business');
		$cmsmasters_page_sections = logistic_business_options_demo_sections();
		$cmsmasters_page_fields = logistic_business_options_demo_fields();
		$cmsmasters_page_tabs = logistic_business_options_demo_tabs();
...
function logistic_business_create_settings_field($args = array()) {
	$defaults = array( 
		'id' => 		'default_field', 
		'title' => 		esc_html__('Default Field', 'logistic-business'), 
		'desc' => 		esc_html__('This is a default description.', 'logistic-business'), 
		'std' => 		'', 
		'type' => 		'text', 
	...
	add_settings_field( 
		esc_attr($id), 
		esc_html($title), 
		'logistic_business_form_field_fn', 
		__FILE__, 
		$section, 
		$field_args 
	);
...
function logistic_business_register_settings() {
	$settings_output = logistic_business_get_settings();
	...
	register_setting($cmsmasters_option_name, $cmsmasters_option_name, 'logistic_business_validate_options');
	
	
	if (!empty($settings_output['cmsmasters_page_sections'])) {
		foreach ($settings_output['cmsmasters_page_sections'] as $id => $title) {
			add_settings_section($id, $title, 'logistic_business_section_fn', __FILE__);
		}
	}
	...
	if (!empty($settings_output['cmsmasters_page_fields'])) {
		foreach ($settings_output['cmsmasters_page_fields'] as $option) {
			logistic_business_create_settings_field($option);
		}
	}
...
function logistic_business_settings_scripts() {
	...
	wp_localize_script('cmsmasters_theme_settings_js', 'cmsmasters_setting', array( 
		...
		'remove_sidebar' => 				esc_html__('Do you realy want to remove this sidebar?', 'logistic-business'), 
		'find' => 							esc_attr__('Find icons', 'logistic-business'), 
		'remove_icon' => 					esc_html__('Do you realy want to remove this social icon?', 'logistic-business'), 
		'theme_uri' => 						get_template_directory_uri(), 
		'shortname' => 						CMSMASTERS_SHORTNAME, 
		'done' => 							esc_html__('All theme settings were imported successfully.', 'logistic-business'), 
		'fail' => 							esc_html__("Error on page!!!\nPlease reload page and try again.", 'logistic-business'), 
...
function logistic_business_add_menu() {
	$settings_output = logistic_business_get_settings();
	...
	$add_menu_p( 
		esc_attr__('Theme Settings', 'logistic-business'), 
		esc_attr__('Theme Settings', 'logistic-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME, 
		'logistic_business_settings_page_fn', 
		'' 
	);
	...
	$cmsmasters_settings_general = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme General Settings', 'logistic-business'), 
		esc_attr__('General', 'logistic-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME, 
		'logistic_business_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_general, 'logistic_business_settings_scripts');
	
	
	$cmsmasters_settings_font = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Fonts Settings', 'logistic-business'), 
		esc_attr__('Fonts', 'logistic-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME . '-font', 
		'logistic_business_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_font, 'logistic_business_settings_scripts');
	
	
	$cmsmasters_settings_color = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Color Schemes', 'logistic-business'), 
		esc_attr__('Colors', 'logistic-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME . '-color', 
		'logistic_business_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_color, 'logistic_business_settings_scripts');
	
	
	$cmsmasters_settings_element = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Elements Settings', 'logistic-business'), 
		esc_attr__('Elements', 'logistic-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME . '-element', 
		'logistic_business_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_element, 'logistic_business_settings_scripts');
	
	
	$cmsmasters_settings_single = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Single Posts Settings', 'logistic-business'), 
		esc_attr__('Single Posts', 'logistic-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME . '-single', 
		'logistic_business_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_single, 'logistic_business_settings_scripts');
	
	
	$cmsmasters_settings_demo = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Settings Import/Export', 'logistic-business'), 
		esc_attr__('Import/Export', 'logistic-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME . '-demo', 
		'logistic_business_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_demo, 'logistic_business_settings_scripts');
}


function logistic_business_section_fn($desc) {
	$tab = logistic_business_get_the_tab();
...
function logistic_business_settings_page_fn() {
	$settings_output = logistic_business_get_settings();
	$current_tab = logistic_business_get_the_tab();
	
	echo '<div class="wrap">';
	
	logistic_business_settings_page_header();
	...
	if ($current_tab != 'wpml') {
		...
		'<p class="submit-top">' . 
			(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit-top" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'logistic-business') . '" />' : '') . 
		'</p>';
		...
		echo '<p class="submit">' . 
				(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'logistic-business') . '" />' : (($current_tab == 'import') ? '<input name="import" type="button" class="button button-primary button-large cmsmasters-demo-import" value="' . esc_attr__('Import Settings', 'logistic-business') . '" />' : '')) . 
			'</p>' . 
		'</form>';
	} else {
		do_settings_sections(__FILE__);
...
function logistic_business_form_field_fn($args = array()) {
	extract($args);
	...
	case 'upload':
		...
		echo '<div class="cmsmasters_upload_parent cmsmasters_select_parent">' . 
			'<input type="button" id="cmsmasters_upload_' . $id . '_button" class="cmsmasters_upload_button button button-large" value="' . esc_attr__('Choose Image', 'logistic-business') . '" data-title="' . esc_attr__('Choose Image', 'logistic-business') . '" data-button="' . esc_attr__('Insert Image', 'logistic-business') . '" data-id="cmsmasters-media-select-frame-' . $id . '" data-classes="media-frame cmsmasters-media-select-frame' . ((!isset($description)) ? ' cmsmasters-frame-no-description' : '') . ((!isset($caption)) ? ' cmsmasters-frame-no-caption' : '') . ((!isset($align)) ? ' cmsmasters-frame-no-align' : '') . ((!isset($link)) ? ' cmsmasters-frame-no-link' : '') . ((!isset($size)) ? ' cmsmasters-frame-no-size' : '') . '" data-library="image" data-type="' . $frame . '"' . (($frame == 'post') ? ' data-state="insert"' : '') . ' data-multiple="' . $multiple . '" />' . 
			'<div class="cmsmasters_upload"' . (($image != '') ? ' style="display:block;"' : '') . '>' . 
				'<img src="' . (($image != '') ? $image : '') . '" class="cmsmasters_preview_image" />' . 
				'<a href="#" class="cmsmasters_upload_cancel admin-icon-remove" title="' . esc_attr__('Remove', 'logistic-business') . '"></a>' . 
			'</div>' . 
	...
	case 'typorgaphy':
		...
		if ($system_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (logistic_business_system_fonts_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_system_font'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_system_font">' . esc_html__('System Font', 'logistic-business') . '</label>' . 
			'</div>';
		}
		...
		if ($google_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_google_font">' . esc_html__('Google Font', 'logistic-business') . '</label>' . 
			'</div>';
		}
		...
		if ($font_size) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_font_size_number">' . esc_html__('Font Size', 'logistic-business') . ' <em>(' . esc_html__('in pixels', 'logistic-business') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($line_height) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_line_height_number">' . esc_html__('Line Height', 'logistic-business') . ' <em>(' . esc_html__('in pixels', 'logistic-business') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($font_weight) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_weight">' . esc_html__('Font Weight', 'logistic-business') . '</label>' . 
			'</div>';
		}
		...
		if ($font_style) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_style">' . esc_html__('Font Style', 'logistic-business') . '</label>' . 
			'</div>';
		}
		...
		if ($text_transform) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (logistic_business_text_transform_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_transform'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_transform">' . esc_html__('Text Transform', 'logistic-business') . '</label>' . 
			'</div>';
		}
		...
		if ($text_decoration) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (logistic_business_text_decoration_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_decoration'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_decoration">' . esc_html__('Text Decoration', 'logistic-business') . '</label>' . 
			'</div>';
		}
	...
	case 'sidebar':
		...
		'<div class="sidebar_management">' . 
			'<p>' . 
				...
				'<input class="button" type="button" id="add_sidebar" value="' . esc_attr__('Add Sidebar', 'logistic-business') . '" />' . 
			'</p>' . 
			'<div></div>' . 
			'<ul>';
	...
	case 'social':
		...
		'<div class="icon_management">' . 
			'<p>' . 
				...
				'<input id="' . $id . '_button" class="cmsmasters_icon_choose_button button" type="button" value="' . esc_attr__('Choose icon', 'logistic-business') . '" />' . 
				'<a href="#" class="cmsmasters_remove_icon admin-icon-remove" title="' . esc_attr__('Cancel changes', 'logistic-business') . '"></a>' . 
			'</p>' . 
			'<span class="cl"><br /></span>' . 
			'<span class="icon_upload_link" style="display:none;">' . 
				'<label for="new_icon_color">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Color', 'logistic-business') . '</span>' . 
				...
				'<label for="new_icon_hover">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Hover Color', 'logistic-business') . '<br /><em>' . esc_html__('if not selected - Icon Color will be used', 'logistic-business') . '</em></span>' . 
				...
				'<label for="new_icon_link">' . 
					...
					esc_html__('Icon Link', 'logistic-business') . 
				'</label>' . 
				'<label for="new_icon_title">' . 
					'<input class="all-options" type="text" id="new_icon_title" /> ' . 
					esc_html__('Icon Title', 'logistic-business') . 
				'</label>' . 
				'<label for="new_icon_target">' . 
					'<input type="checkbox" id="new_icon_target" value="true" /> ' . 
					esc_html__('Open link in a new tab/window?', 'logistic-business') . 
				'</label>' . 
			'</span>' . 
			'<span class="cl"></span>' . 
			'<input class="button button-primary" type="button" id="add_icon" value="' . esc_attr__('Add Icon', 'logistic-business') . '" />' . 
			'<input class="button button-primary" type="button" id="edit_icon" value="' . esc_attr__('Save Icon', 'logistic-business') . '" />' . 
			'<ul>';
			...
			if (isset($options[$id]) && is_array($options[$id])) {
				foreach($options[$id] as $icon) {
					...
					echo '<li>' . 
						...
						'</div>' . 
						'<a href="#" class="icon_del admin-icon-remove" title="' . esc_attr__('Remove', 'logistic-business') . '"></a> ' . 
...
function logistic_business_validate_options($input) {
	$valid_input = array();
	...
	foreach ($options as $option) {
		...
		case 'text':
			...
			case 'numeric':
				...
				$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Expecting a Numeric value!', 'logistic-business');
				
				if (is_numeric($input[$option['id']]) == false) {
					add_settings_error(
						$option['id'],
						CMSMASTERS_SHORTNAME . '_txt_numeric_error',
						esc_html__('Expecting a Numeric value! Please fix.', 'logistic-business'),
						'error'
					);
				}
			...
			case 'multinumeric':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) == 1) ? $input[$option['id']] : esc_html__('Expecting comma separated numeric values', 'logistic-business');
				} else {
				...
				if ($input[$option['id']] != '' && preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) != 1) {
					add_settings_error(
						...
						esc_html__('Expecting comma separated numeric values! Please fix.', 'logistic-business'),
						'error'
					);
				}
			...
			case 'email':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (is_email($input[$option['id']]) !== false) ? $input[$option['id']] : esc_html__('Invalid email! Please re-enter!', 'logistic-business');
				} elseif ($input[$option['id']] == '') {
					$valid_input[$option['id']] = esc_html__('This setting field cannot be empty! Please enter a valid email address.', 'logistic-business');
				}
				...
				if (is_email($input[$option['id']]) == false || $input[$option['id']] == '') {
					add_settings_error(
						...
						esc_html__('Please enter a valid email address.', 'logistic-business'),
						'error'
					);
				}
		...
		case 'number':
			$input[$option['id']] = trim($input[$option['id']]);
			$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Number!', 'logistic-business');
...
function theme_admin_bar_render() {
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Theme Settings', 'logistic-business'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('General', 'logistic-business'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings')) 
	));
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Fonts', 'logistic-business'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Colors', 'logistic-business'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Elements', 'logistic-business'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Single', 'logistic-business'), 
...
function logistic_business_show_msg($message, $msgclass = 'info') {
	echo '<div id="message" class="' . $msgclass . '">' . $message . '</div>';
}


function logistic_business_admin_msgs() {
	global $pagenow;
	...
	if ($pagenow == 'admin.php' && current_user_can('manage_options') && $cmsmasters_settings_pg !== false && !empty($set_errors)) {
		if ($set_errors[0]['code'] == 'settings_updated' && isset($_GET['settings-updated'])) {
			logistic_business_show_msg('<p><strong>' . $set_errors[0]['message'] . '</strong></p>', 'updated');
		} else {
			foreach ($set_errors as $set_error) {
				logistic_business_show_msg('<p class="setting-error-message" title="' . esc_attr($set_error['setting']) . '">' . $set_error['message'] . '</p>', 'error');
			}
		}
	}
}

add_action('admin_notices', 'logistic_business_admin_msgs');


function logistic_business_add_global_options() {
	$cmsmasters_option_names = array( 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_general', 
			logistic_business_options_general_fields('general') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_bg', 
			logistic_business_options_general_fields('bg') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_header', 
			logistic_business_options_general_fields('header') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_content', 
			logistic_business_options_general_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_footer', 
			logistic_business_options_general_fields('footer') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_font_content', 
			logistic_business_options_font_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_font_link', 
			logistic_business_options_font_fields('link') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_font_nav', 
			logistic_business_options_font_fields('nav') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_font_heading', 
			logistic_business_options_font_fields('heading') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_font_other', 
			logistic_business_options_font_fields('other') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_element_sidebar', 
			logistic_business_options_element_fields('sidebar') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_element_icon', 
			logistic_business_options_element_fields('icon') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_element_lightbox', 
			logistic_business_options_element_fields('lightbox') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_element_sitemap', 
			logistic_business_options_element_fields('sitemap') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_element_error', 
			logistic_business_options_element_fields('error') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_element_code', 
			logistic_business_options_element_fields('code') 
		), 
		array( 
		...
		array( 
			...
			logistic_business_options_single_fields('post') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_single_project', 
			logistic_business_options_single_fields('project') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_single_profile', 
			logistic_business_options_single_fields('profile') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_single_tt_event', 
			logistic_business_options_single_fields('tt_event') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_single_lpr_course', 
			logistic_business_options_single_fields('lpr_course') 
		)
	);
	...
	foreach (logistic_business_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, array( 
			...
			logistic_business_options_color_fields($key) 
		));
	}
...
function logistic_business_get_global_options() {
