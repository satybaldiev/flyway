...
function logistic_business_get_admin_page() {
	global $pagenow;
...
function logistic_business_default_tab() {
	$current_page = logistic_business_get_admin_page();
...
function logistic_business_get_the_tab() {
	global $pagenow;
	
	$default_tab = logistic_business_default_tab();
...
function logistic_business_settings_page_header() {
