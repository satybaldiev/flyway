...
class WP_Widget_Custom_Contact_Info extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_html__('Your contact information', 'logistic-business') 
		);
		...
		parent::__construct('custom-contact-info', esc_attr__('Contact Information', 'logistic-business'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Contact Information', 'logistic-business') : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        ?>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title', 'logistic-business'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('name')); ?>"><?php esc_html_e('Name', 'logistic-business'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('name')); ?>" name="<?php echo esc_attr($this->get_field_name('name')); ?>" type="text" value="<?php echo esc_attr($name); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('url')); ?>"><?php esc_html_e('Website', 'logistic-business'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('url')); ?>" name="<?php echo esc_attr($this->get_field_name('url')); ?>" type="text" value="<?php echo esc_attr($url); ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('Email', 'logistic-business'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('email')); ?>" name="<?php echo esc_attr($this->get_field_name('email')); ?>" type="text" value="<?php echo esc_attr($email); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php esc_html_e('Phone', 'logistic-business'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('phone')); ?>" name="<?php echo esc_attr($this->get_field_name('phone')); ?>" type="text" value="<?php echo esc_attr($phone); ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php esc_html_e('Address', 'logistic-business'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('address')); ?>" name="<?php echo esc_attr($this->get_field_name('address')); ?>" type="text" value="<?php echo esc_attr($address); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('city')); ?>"><?php esc_html_e('City', 'logistic-business'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('state')); ?>"><?php esc_html_e('State', 'logistic-business'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('zip')); ?>"><?php esc_html_e('Zip', 'logistic-business'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('country')); ?>"><?php esc_html_e('Country', 'logistic-business'); ?>:<br />
...
class WP_Widget_Custom_Latest_Projects extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Latest projects from your portfolio', 'logistic-business') 
		);
		
		parent::__construct('custom-latest-projects', esc_attr__('Latest Projects', 'logistic-business'), $widget_ops);
	}
	
    function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Latest Projects', 'logistic-business') : $instance['title'], $instance, $this->id_base);
        ...
        if ($lp->have_posts()) { 
            ...
            while ($lp->have_posts()) : $lp->the_post();
				...
				logistic_business_get_project_category(get_the_ID(), 'pj-categs');
				
				logistic_business_project_exc_cont();
				
				logistic_business_get_project_likes();
				
				logistic_business_get_project_comments();
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('type')); ?>"><?php esc_html_e('Show Only from Projects Type', 'logistic-business'); ?>:<br />
                <select id="<?php echo esc_attr($this->get_field_id('type')); ?>" name="<?php echo esc_attr($this->get_field_name('type')); ?>" class="widefat">
                    <option value=""><?php esc_html_e('Show all projects', 'logistic-business'); ?>&nbsp;</option>
				<?php 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of latest projects you'd like to display", 'logistic-business'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'logistic-business'); ?> 3</small><br />
            </label>
        </p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('autoplay')); ?>"><?php esc_html_e('Autoplay', 'logistic-business'); ?></label>
		</p>
        <div class="cl"></div>
        <?php
    }
...
class WP_Widget_Custom_Popular_Projects extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Popular projects from your portfolio', 'logistic-business') 
		);
		
		parent::__construct('custom-popular-projects', esc_attr__('Popular Projects', 'logistic-business'), $widget_ops);
	}
	
    function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Popular Projects', 'logistic-business') : $instance['title'], $instance, $this->id_base);
		$type = isset($instance['type']) ? $instance['type'] : '';
		$number = isset($instance['number']) ? (int) $instance['number'] : '';
        $autoplay = isset($instance['autoplay']) ? $instance['autoplay'] : false;
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of popular projects you'd like to display", 'logistic-business'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'logistic-business'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_Posts_Tabs extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Latest, popular posts & recent comments', 'logistic-business') 
		);
		
		parent::__construct('custom-posts-tabs', esc_attr__('Posts Tabs', 'logistic-business'), $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		if ($latest) {
			echo '<li class="cmsmasters_tabs_list_item current_tab">' . 
				'<a href="#"><span>' . esc_html__('Latest', 'logistic-business') . '</span></a>' . 
			'</li>'; 
		}
		
		if ($popular) {
			echo '<li class="cmsmasters_tabs_list_item' . ((!$latest) ? ' current_tab' : '') . '">' . 
				'<a href="#"><span>' . esc_html__('Popular', 'logistic-business') . '</span></a>' . 
			'</li>'; 
		}
		
		if ($recent) {
			echo '<li class="cmsmasters_tabs_list_item' . ((!$latest && !$popular) ? ' current_tab' : '') . '">' . 
				'<a href="#"><span>' . esc_html__('Comments', 'logistic-business') . '</span></a>' . 
			'</li>'; 
		}
			...
			if ($l->have_posts()) { 
				...
				while ($l->have_posts()) : $l->the_post();
					...
					if ($pt_format == 'image' || $pt_format == 'gallery') {
						...
						if (has_post_thumbnail()) {
							logistic_business_thumb(get_the_ID(), 'cmsmasters-small-thumb', true, false, false, false, false, true, false);
							...
							foreach ($attachments as $attachment) { 
								if (!isset($att_counter) && $att_counter = true) { 
									logistic_business_thumb(get_the_ID(), 'cmsmasters-small-thumb', true, false, false, false, false, true, $attachment->ID);
								}
							}
						} else {
						...
						echo '<div class="cmsmasters_lpr_cont">' . 
							...
							'<br />' . 
							'<small>' . 
								'<abbr class="published" title="' . esc_attr(get_the_time('d-m-Y')) . '">' . human_time_diff(get_the_time('U'), current_time('timestamp')) . ' ' . esc_html__('ago', 'logistic-business') . '</abbr>' . 
							'</small>' . 
						'</div>' . 
						'<div class="cl"></div>' . 
					'</li>';
			...
			if ($rcomments) { 
				...
				foreach ($rcomments as $comment) {
					...
					echo '<li>' . 
						...
						' <span>' . esc_html__('on', 'logistic-business') . '</span> <a href="' . get_permalink($comment_post_ID) . '#comments" rel="bookmark">' . cmsmasters_title($comment_post_ID, false) . '</a>' . 
						'<small>' . 
							'<abbr class="published" title="' . esc_attr(get_the_time('d-m-Y')) . '">' . human_time_diff($comment_date, current_time('timestamp')) . ' ' . esc_html__('ago', 'logistic-business') . '</abbr>' . 
						'</small>' . 
    ...
    function form($instance) {
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('latest')); ?>"><?php esc_html_e('Latest Posts', 'logistic-business'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('popular')); ?>"><?php esc_html_e('Popular Posts', 'logistic-business'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('recent')); ?>"><?php esc_html_e('Recent Comments', 'logistic-business'); ?></label>
		</p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of recent comments, popular and latest posts you'd like to display", 'logistic-business'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'logistic-business'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_Twitter extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Your Twitter account latest tweets', 'logistic-business') 
		);
		
		parent::__construct('custom-twitter', esc_attr__('Twitter', 'logistic-business'), $widget_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Twitter', 'logistic-business') : $instance['title'], $instance, $this->id_base);
		...
		if ($user != '') {
			...
			if ($tweets != '') {
				...
				foreach ($tweets as $t) {
					echo '<li>' . "\n" . 
						'<span class="tweet_time">' . human_time_diff($t['time'], current_time('timestamp')) . ' ' . esc_html__('ago', 'logistic-business') . '</span>' . "\n" . 
				...
				echo '<div class="cmsmasters_notice cmsmasters_notice_error cmsmasters_theme_icon_cancel">' . "\n" . 
					'<div class="notice_content">' . "\n" . 
						'<p>' . esc_html__('Please add your Twitter API keys', 'logistic-business') . ', ' . '<a target="_blank" href="http://cmsmasters.net/twitter-functionality/">' . esc_html__('read more how', 'logistic-business') . '</a></p>' . "\n" . 
					'</div>' . "\n" . 
				'</div>' . "\n";
			}
		}
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('user')); ?>"><?php esc_html_e('Twitter Username', 'logistic-business'); ?>:<br />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of latest tweets you'd like to display", 'logistic-business'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'logistic-business'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_PayPalDonations extends WP_Widget {
		...
		echo wp_kses_post($before_widget) . 
			'<div class="cmsmasters_paypal_donations_widget">' . "\n";
				...
				echo '<div class="cmsmasters_paypal_donations">' . "\n" . 
					...
					'<span class="button">' . ($button_text ? esc_html($button_text) : esc_html__('Donate', 'logistic-business')) . '</span>' . "\n" . 
				'</div>' . "\n" . 
			'</div>' . "\n" . 
		$after_widget;
    }
    ...
    public function form($instance) {
		$defaults = array(
			'title' => 			esc_attr__('Donate', 'logistic-business'),
			'text' => 			'',
			'purpose' => 		'',
			'reference' => 		'',
			'amount' => 		'',
		...
		?>
		<p>
			<label for="<?php echo esc_attr($title_id); ?>"><?php esc_html_e('Title:', 'logistic-business'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($text_id); ?>"><?php esc_html_e('Text:', 'logistic-business'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($purpose_id); ?>"><?php esc_html_e('Purpose:', 'logistic-business'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($reference_id); ?>"><?php esc_html_e('Reference:', 'logistic-business'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($amount_id); ?>"><?php esc_html_e('Amount:', 'logistic-business'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($button_text_id); ?>"><?php esc_html_e('Button Text:', 'logistic-business'); ?> 
...
class WP_Widget_Custom_Booking extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'widget_custom_booking_entries', 'description' => esc_attr__('Your booking', 'logistic-business'));
		$control_ops = array('width' => 600);
		parent::__construct('custom-booking', '&nbsp;' . esc_attr__('Booking a Visit', 'logistic-business'), $widget_ops, $control_ops);
    ...
    function form($instance) {
        ...
        <p style="width:48%; float:left; padding-right:4%; clear:both;">
            <label for="<?php echo esc_attr($this->get_field_id('block_color_1')); ?>"><?php esc_html_e('First Block Background', 'logistic-business'); ?>:<br />
        ...
        <p style="width:48%; float:right;">
            <label for="<?php echo esc_attr($this->get_field_id('block_color_2')); ?>"><?php esc_html_e('Second Block Background', 'logistic-business'); ?>:<br />
        ...
        <p style="width:48%; float:left; padding-right:4%; clear:both;">
            <label for="<?php echo esc_attr($this->get_field_id('title_1')); ?>"><?php esc_html_e('First Block Title', 'logistic-business'); ?>:<br />
        ...
        <p style="width:48%; float:right;">
            <label for="<?php echo esc_attr($this->get_field_id('title_2')); ?>"><?php esc_html_e('Second Block Title', 'logistic-business'); ?>:<br />
        ...
        <p style="width:48%; float:left; padding-right:4%; clear:both;">
            <label for="<?php echo esc_html($this->get_field_id('text_1')); ?>"><?php esc_html_e('First Block Custom HTML', 'logistic-business'); ?>:<br />
        ...
        <p style="width:48%; float:right;">
            <label for="<?php echo esc_html($this->get_field_id('text_2')); ?>"><?php esc_html_e('Second Block Custom HTML', 'logistic-business'); ?>:<br />
        ...
        <p style="width:100%; clear:both;">
            <label for="<?php echo esc_attr($this->get_field_id('block_color_3')); ?>"><?php esc_html_e('Form Block Background', 'logistic-business'); ?>:<br />
        ...
        <p style="width:100%; clear:both;">
            <label for="<?php echo esc_attr($this->get_field_id('title_3')); ?>"><?php esc_html_e('Form Block Title', 'logistic-business'); ?>:<br />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('ctf')); ?>"><?php esc_html_e('Select Contact Form 7', 'logistic-business'); ?>:<br />
...
function logistic_business_theme_add_custom_widgets($widgets) {
...
add_filter('cmsmasters_custom_widgets_filter', 'logistic_business_theme_add_custom_widgets');
