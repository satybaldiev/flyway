...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Posts', 'logistic-business');


$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'logistic-business');


$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All Categories', 'logistic-business');
